...
import util from 'bcoin/lib/utils/util'
import crypto from 'bcoin/lib/crypto/crypto'
import IP from 'bcoin/lib/utils/ip'
import BufferWriter from 'bcoin/lib/utils/writer'
...
WSProxy.prototype._handleConnect = function _handleConnect (ws, port, host, nonce) {
  ...
  if (!util.isNumber(port) || typeof host !== 'string' || host.length === 0) {
